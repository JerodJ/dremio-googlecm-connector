...
@SourceType(value = "GoogleCMARP", label = "GoogleCM",uiConfig = "googlecm-layout.json")
public class GoogleCMConf extends AbstractArpConf<GoogleCMConf> {
  private static final String ARP_FILENAME = "arp/implementation/googlecm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googlecm.GoogleCMDriver";
